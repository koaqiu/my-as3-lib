package com.CGFinal.Controls {
	...
	public class ScrollBar extends LiteComponent{
		...
		override protected function createChildren():void {
			...
			this._bg = super.createObject("ScrollTrackSkin") as Sprite;
			this._bg.addEventListener(MouseEvent.CLICK, DPE_TrackClick);
			this._scrollArrowUp = super.createObject("ScrollArrowUpSkin") as Sprite;
			this._scrollArrowUp.addEventListener(MouseEvent.CLICK, DPE_ArrowClick);
			this._scrollArrowDown = super.createObject("ScrollArrowDownSkin") as Sprite;
			this._scrollArrowDown.addEventListener(MouseEvent.CLICK, DPE_ArrowClick);
			this._scrollThumb = super.createObject("ScrollThumbSkin") as Sprite;
			this._scrollBarThumbIcon = super.createObject("ScrollBarThumbIcon") as Sprite;
		...
		override public function SetSize(width:Number, height:Number):void {
			...
			this.ChangeDragRect(this._scrollDragBar, rect);
		}
		override public function DataBind():void {
			super.DataBind();
			var rect:Rectangle = new Rectangle(0, this._scrollArrowUp.height, 0, this.height - this._scrollArrowUp.height - this._scrollArrowDown.height - this._scrollThumb.height);
			this.MakeItCanDrag(this._scrollDragBar, rect,
